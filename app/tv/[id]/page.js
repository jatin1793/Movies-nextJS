...
const page =  ({ params }) => {
    ...
    useEffect(() => {
        axios.get(`https://api.themoviedb.org/3/tv/${params.id}?api_key=16242317f3764cb8c2c121692d453792`)
            .then((res) => {
            ...
            axios.get(`https://api.themoviedb.org/3/tv/${params.id}/videos?api_key=16242317f3764cb8c2c121692d453792`)
            .then((res) => {
            ...
            <div className='full'>
                ...
                <div className="dets">
                    ...
                    {trailer ? (
                        ...
                        // Optionally, you can provide an alternative UI or leave it empty
                        <p style={{ color : "red" , marginTop: "5vh"}}>No trailer available !!</p>
                    )}
                </div>
            </div>
        </div>
